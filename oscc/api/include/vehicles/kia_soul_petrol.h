 ...
 */
#define THROTTLE_SPOOF_HIGH_SIGNAL_RANGE_MIN ( 328 )
 ...
 */
#define THROTTLE_SPOOF_HIGH_SIGNAL_RANGE_MAX ( 4080 )
 ...
 *
 */
#define ACCELERATOR_OVERRIDE_THRESHOLD ( 250.0 )
